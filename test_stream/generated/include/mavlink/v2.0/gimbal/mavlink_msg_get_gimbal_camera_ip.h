...
#define MAVLINK_MSG_ID_GET_GIMBAL_CAMERA_IP 300129
...
#define MAVLINK_MSG_ID_300129_LEN 1
#define MAVLINK_MSG_ID_300129_MIN_LEN 1

#define MAVLINK_MSG_ID_GET_GIMBAL_CAMERA_IP_CRC 254
#define MAVLINK_MSG_ID_300129_CRC 254
