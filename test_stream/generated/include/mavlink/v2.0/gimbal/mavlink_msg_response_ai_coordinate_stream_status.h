...
#define MAVLINK_MSG_ID_RESPONSE_AI_COORDINATE_STREAM_STATUS 40078
...
#define MAVLINK_MSG_ID_40078_LEN 1
#define MAVLINK_MSG_ID_40078_MIN_LEN 1

#define MAVLINK_MSG_ID_RESPONSE_AI_COORDINATE_STREAM_STATUS_CRC 25
#define MAVLINK_MSG_ID_40078_CRC 25
